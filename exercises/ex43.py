...
class Death(Scene):
	...
	quips = [
	    "You died. You kinda suck at at this.",
...
class CentralCorridor(Scene):
    ...
    def enter(self):
        ...
        if action == "shoot!":
        	...
        	print "His clown custome is flowing and moving his body. which throws"
        	print "off your aim. Your laser hits his custome but misses him entirely. This"
